        ...
        if st.button(
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    with col2:
                        st.metric("Tables", result.get("tables", 0))
                        st.metric("Images", result.get("images", 0))
                    with col3:
                        st.metric("Embeddings", result.get("embeddings", 0))
                        st.metric("OCR Docs", result.get("ocr_documents", 0))
                else:
